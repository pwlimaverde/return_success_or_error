...
2 - Usecase dividido em duas classes ´´´UsecaseBaseCallData´´´ que precisa receber um Datasource para chamada externa, e ´´´UsecaseBase´´´ que é usado para execultar a regra de negocio diretamente, sem a necessidade de Datasource.
3 - Correção da documentação.
